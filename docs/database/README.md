...
- [`guides/model_decorators.md`](./guides/model_decorators.md) — `@hidden` decorator + `Model.toJSON()`, inheritance rules, custom `toJSON` overrides, runtime metadata inspection, what's deferred (`@cast` / `@encrypt` / `@ulid`).
