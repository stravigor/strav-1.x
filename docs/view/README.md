...
> **Status: 1.0.0-alpha.7 — engine + islands + pages auto-router + console commands shipped.** `resources/views/pages/**/*.strav` files are automatically registered as GET routes by `ViewProvider.boot()`. See `docs/view/guides/pages.md`.
