/**
 * `OpenAIProvider` tests — shape translation + agentic-loop behavior.
 *
...
describe('OpenAIProvider — chat() request shape', () => {
...
describe('OpenAIProvider — chat() response shape', () => {
...
describe('OpenAIProvider — runWithTools()', () => {
