/**
 * `OllamaProvider` tests — verifies the divergences from
 * `OpenAIProvider`:
 *
...
describe('OllamaProvider.buildParams', () => {
...
describe('OllamaProvider — defaults', () => {
...
describe('OllamaProvider — inherits runWithTools', () => {
