/**
 * AnthropicProvider tool-shape translation + agentic-loop tests.
 *
...
describe('AnthropicProvider.runWithTools — tool definition shape', () => {
...
describe('AnthropicProvider.runWithTools — no tool use', () => {
...
describe('AnthropicProvider.runWithTools — single tool round-trip', () => {
...
describe('AnthropicProvider.runWithTools — error wrapping', () => {
...
describe('AnthropicProvider.runWithTools — maxIterations ceiling', () => {
...
describe('AnthropicProvider.runWithTools — context propagation', () => {
