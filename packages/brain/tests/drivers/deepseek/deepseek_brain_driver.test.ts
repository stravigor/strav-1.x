/**
 * `DeepSeekBrainDriver` tests — covers the divergences from
 * `OpenAIBrainDriver`:
 *
...
describe('DeepSeekBrainDriver.buildParams', () => {
...
describe('DeepSeekBrainDriver — defaults', () => {
...
describe('DeepSeekBrainDriver.generate', () => {
...
describe('DeepSeekBrainDriver — runWithToolsAndSchema (tool-forcing)', () => {
...
describe('DeepSeekBrainDriver — streamWithToolsAndSchema (tool-forcing)', () => {
...
describe('DeepSeekBrainDriver — inherits runWithTools end-to-end', () => {
