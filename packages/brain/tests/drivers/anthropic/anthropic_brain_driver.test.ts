/**
 * `AnthropicBrainDriver` tests — exercise the shape translation between
...
describe('AnthropicBrainDriver — chat() request shape', () => {
...
describe('AnthropicBrainDriver — chat() response shape', () => {
...
describe('AnthropicBrainDriver — stream()', () => {
...
describe('AnthropicBrainDriver — countTokens()', () => {
