 ...
 * even with `FORCE ROW LEVEL SECURITY` set on a table — so RLS-isolation
 * assertions can't pass under them. Tests use this to self-skip the
 * RLS-scoping check while still exercising the rest of the tenancy path.
 *
